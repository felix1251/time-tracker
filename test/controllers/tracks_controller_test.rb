...
class TracksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create track' do
    assert_difference('Track.count') do
      post tracks_url, params: { track: { activity: @track.activity, tag_id: @track.tag_id, user_id: @track.user_id } }
    end
  ...
  test 'should update track' do
    patch track_url(@track),
          params: { track: { activity: @track.activity, tag_id: @track.tag_id, user_id: @track.user_id } }
